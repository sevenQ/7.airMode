...
public class Alarms {
    ...
    public static final String ALARM_ALERT_ACTION = "seven.airMode.timer.ALARM_ALERT";
    ...
    public static final String ALARM_DONE_ACTION = "seven.airMode.timer.ALARM_DONE";
    ...
    public static final String ALARM_SNOOZE_ACTION = "seven.airMode.timer.ALARM_SNOOZE";

    // AlarmAlertFullScreen listens for this broadcast intent, so that other applications
    // can dismiss the alarm (after ALARM_ALERT_ACTION and before ALARM_DONE_ACTION).
    public static final String ALARM_DISMISS_ACTION = "seven.airMode.timer.ALARM_DISMISS";
    ...
    private static void clearSnoozeIfNeeded(Context context, long alarmTime) {
        ...
        SharedPreferences prefs =
                context.getSharedPreferences(Main.PREFERENCES, 0);
        ...
        if (cur.moveToFirst()) {
            do {
                ...
                if (alarm.time != 0 && alarm.time < now) {
                        LogHelper.d(TAG + "** DISABLE " + alarm.id + " now " + now +" set "
                                + alarm.time);
    ...
    private static void enableAlert(Context context, final Alarm alarm,
        ...
        AlarmManager am = (AlarmManager)
            ...
            LogHelper.d(TAG +"** setAlert id " + alarm.id + " atTime " + atTimeInMillis);
