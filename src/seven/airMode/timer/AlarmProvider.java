...
public class AlarmProvider extends ContentProvider {
    ...
    static {
        sURLMatcher.addURI("seven.airMode.timer", "alarm_seven", ALARMS);
        sURLMatcher.addURI("seven.airMode.timer", "alarm_seven/#", ALARMS_ID);
    }
    ...
    private static class DatabaseHelper extends SQLiteOpenHelper {
        ...
        public void onCreate(SQLiteDatabase db) {
            ...
            String insertMe = "INSERT INTO alarms " +
                    ...
                    "VALUES ";
            db.execSQL(insertMe + "(1, 00, 127, 0, 1, 1, 'Enable AirMode.', '');");
            db.execSQL(insertMe + "(6, 00, 127, 0, 1, 0, 'Disable AirMode.', '');");
        }
    ...
    public Cursor query(Uri url, String[] projectionIn, String selection,
        ...
        if (ret == null) {
        	LogHelper.d(TAG+"Alarms.query: failed");
        } else {
    ...
    public int update(Uri url, ContentValues values, String where, String[] whereArgs) {
        ...
        LogHelper.d(TAG+"*** notifyChange() rowId: " + rowId + " url " + url);
    ...
    public Uri insert(Uri url, ContentValues initialValues) {
        ...
        LogHelper.d(TAG+"Added alarm rowId = " + rowId);
