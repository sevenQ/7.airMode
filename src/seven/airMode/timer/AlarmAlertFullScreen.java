...
public class AlarmAlertFullScreen extends Activity {
    ...
    private void dismiss(boolean killed) {
    	//LogHelper.d(TAG+killed ? "Alarm killed" : "Alarm dismissed by user");
    ...
    protected void onNewIntent(Intent intent) {
        ...
        LogHelper.d(TAG+"AlarmAlert.OnNewIntent()");
    ...
    public void onDestroy() {
        super.onDestroy();
        LogHelper.d(TAG+"AlarmAlert.onDestroy()");
